...
var Layout = function() {
    ...
    var handleSidebarMenuActiveLink = function(mode, el, $state) {
        ...
        if (mode === 'click') {
            if (App.getViewPort().width < 300 && $('.page-sidebar').hasClass('in')) { // close the menu on mobile view while laoding a page 
    ...
    var handleSidebarMenu = function() {
        $('.page-sidebar').on('click', 'li > a', function(e) {
            ...
            if (App.getViewPort().width >= 300 && $(this).parents('.page-sidebar-menu-hover-submenu').size() === 1) { // exit of hover sidebar menu
                return;
            }
    ...
    var handleFixedSidebar = function() {
        ...
        if (App.getViewPort().width >= 300 && !$('body').hasClass('page-sidebar-menu-not-fixed')) {
